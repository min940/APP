...
// Load signing config from local.properties (never committed) if present.
...
android {
    namespace = "com.miracle.perapprotation"
    compileSdk = 35
    ...
    signingConfigs {
        // Optional release signing. Provide these keys in local.properties to enable
        // a signed release build. Never commit the keystore or its passwords.
